...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Jonathan Fotland"
  # spec.authors            = { "Jonathan Fotland" => "jonathan@agora.io" }
  # spec.social_media_url   = "https://twitter.com/Jonathan Fotland"
  ...
  #spec.source       = { :git => "http://EXAMPLE/AgoraVideoViewController.git", :tag => "#{spec.version}" }
  spec.source        = { :path => '.'}
